...
///
namespace libMultiRobotPlanning {
    class Environment_fg {
    public:
        Environment_fg(size_t dimx, size_t dimy, size_t dimz,
        ...
        Environment_fg(const Environment_fg &) = delete;

        Environment_fg &operator=(const Environment_fg &) = delete;
