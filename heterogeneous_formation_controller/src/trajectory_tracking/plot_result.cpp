...
int main(int argc, char **argv)
{
	...
	auto traj_fol_diff_r1 = generate_traj("/home/weijian/hmfpc_test_ws/src/heterogeneous_formation_controller/traj_test_diff4_1.yaml");
	auto traj_fol_diff_r2 = generate_traj("/home/weijian/hmfpc_test_ws/src/heterogeneous_formation_controller/traj_test_diff4_2.yaml");
	for (int i = 0; i < traj_1.size(); i++) {
