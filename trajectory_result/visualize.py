...
plt.ylim(bottom=0)
plt.savefig('fg_plan_time.pdf', bbox_inches='tight')
...
file_path2 = "/home/weijian/Heterogeneous_formation/src/liom_local_planner/traj_result/experiment_2.yaml"
file_path3 = "/home/weijian/Heterogeneous_formation/src/liom_local_planner/traj_result/experiment_3.yaml"
file_path4 = "/home/weijian/Heterogeneous_formation/src/liom_local_planner/traj_result/experiment_4.yaml"
file_coord = "/home/weijian/Heterogeneous_formation/src/liom_local_planner/traj_result/experiment_coord.yaml"
# 从 YAML 文件中读取向量组
...
for vector in vectors3:
    new_data3 = (vector[0], vector[1] + vector[2] + vector[3])
    data3.append(new_data3)
for vector in vectors4:
    new_data4 = (vector[0], vector[1] + vector[2] + vector[3])
...
line2 = ax1.scatter(first_numbers3[0:190], second_numbers3[0:190], color='red', label='Triangular formation', alpha=0.2)
coefficients2 = np.polyfit(first_numbers3[0:190], second_numbers3[0:190], 1)  # 1代表线性拟合
polynomial2 = np.poly1d(coefficients2)
y2_fit = polynomial2(first_numbers3[0:190])
plt.plot(first_numbers3[0:190], y2_fit, color='red', linewidth='4', linestyle='-', label='Triangular formation')
...
data = np.array([
    [2.689, 42.165, 1978.270],
    [2.974, 49.805, 2609.209],
    [2.912, 42.225, 2674.600]
])
std = np.array([
    [1.572, 24.737, 1086.645],
    [1.251, 31.965, 1456.069],
    [1.788, 24.983, 1231.121]
])
# 计算每列的标准差
