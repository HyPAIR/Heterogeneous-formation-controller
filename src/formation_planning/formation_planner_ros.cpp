...
//     visualization::Init(nh, config_.global_frame, "fp_markers");
...
//   DrawTrajectoryRviz(solution_, planner_config_, 0, path_pub);
//   DrawTrajectoryRviz(solution_car, planner_config_, 1, path_pub_car1);
//   DrawTrajectoryRviz(solution_diff_drive1, planner_config_, 2, path_pub_diff1);
//   nav_msgs::Path msg;
...
//   }
  ...
  bool show_cr = false;
  while (ros::ok()) {
  bool plan_result = planner_->Plan(solution_, start_state_, goal_state_, iris_problem, solution_, coarse_path_time, solve_time_leader, show_cr);
