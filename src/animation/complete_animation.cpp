...
int main(int argc, char* argv[])
{
    ...
    std::string file_front = "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/complete_demo/result/";
    ...
    vector<double> robot_type = {1, 0, 1, 1, 0, 1, 1, 0, 1, 1, 0, 1, 1, 0, 1};
    std::vector<std::vector<int>> priority_set = generate_priority_set(file_front + "priority.yaml");
    auto plan =  generate_traj_fg("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/ras_demo/formation_generation/fg_complete.yaml", 15);
    ...
    visualization::Init(nh, "odom", "/fg_test_vis");
    ...
    ros::Publisher path_pub_car1 = nh.advertise<nav_msgs::Path>("/fg_test_path_car1", 1, false);
    ros::Publisher path_pub_car2 = nh.advertise<nav_msgs::Path>("/fg_test_path_car2", 1, false);
    ros::Publisher path_pub_car3 = nh.advertise<nav_msgs::Path>("/fg_test_path_car3", 1, false);
    ros::Publisher path_pub_car4 = nh.advertise<nav_msgs::Path>("/fg_test_path_car4", 1, false);
    ros::Publisher path_pub_car5 = nh.advertise<nav_msgs::Path>("/fg_test_path_car5", 1, false);
    ...
    std::vector<double> theta_set = {-1.5707963267948966, 0, 0, 1.5707963267948966, 1.5707963267948966,
         0, 0, 0, 0, 1.5707963267948966,
        -1.5707963267948966, -1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966};
    std::vector<double> theta_set_ = {2.3561944901923448, 2.3561944901923448, -0.78539816339744828, -0.78539816339744828, -0.78539816339744828,
        2.3561944901923448, 2.3561944901923448, -0.78539816339744828, -0.78539816339744828,-0.78539816339744828,
        2.3561944901923448, 2.3561944901923448, -2.3561944901923448, -0.78539816339744828, -0.78539816339744828};
    while (ros::ok()) {
        for (int i = 0; i < 4; i++) {
